...
// Keep the Interface for the main Card as it actually has a unique member
...
function Card({ className, size = "default", ...props }: CardProps) {
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-4 overflow-hidden rounded-xl bg-card cursor-pointer py-4 text-sm text-card-foreground ring-1 ring-foreground/10",
